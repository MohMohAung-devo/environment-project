  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-screen-2xl h-[65vh]  m-auto flex flex-row justify-between items-center align-middle py-0 px-10">
          <div className="w-2/4 h-[100%] flex flex-col justify-center  px-5">
            <h1 className="text-3xl text-white font-thin uppercase">
              hottest temperaute at Myanmar in 2024
            </h1>
            <h1 className="text-4xl text-white mt-5 uppercase">
              Take care world
            </h1>
      ...
      <div className="w-3/4 m-auto h-[35vh]   flex flex-col  justify-center items-center ">
        ...
        <p className="text-lg mt-4 text-center  uppercase border-b-2 border-green-900">
